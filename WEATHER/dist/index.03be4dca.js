...
const api = function(country) {
    const API_example = fetch(`http://api.weatherapi.com/v1/current.json?key=91a3164fcb414f28a53163242230909&q=${country}&aqi=no`).then((res)=>res.json()).then((data)=>console.log(data));
};

//# sourceMappingURL=index.03be4dca.js.map
